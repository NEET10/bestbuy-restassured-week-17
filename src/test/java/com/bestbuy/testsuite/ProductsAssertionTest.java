...
public class ProductsAssertionTest {
    ...
    public void test017() {
        ...
        List<Double> price = response.extract().path("data.findAll{it.name =='data[3].price'}");
        System.out.println("------------------StartingTest---------------------------");
        System.out.println("'data[3]' is : " + price);
    ...
    @Test
    public void test020() {
        //  response.body("data[9].categories", sizeOfData.size());
        List<Integer> sizeOfData = response.extract().path("data[9].categories");
